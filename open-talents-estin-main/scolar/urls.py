...
#    re_path(r'^deliberation_periode_calcul/(?P<formation_pk>\d+)/(?P<periode_pk>\d+)/$', views.deliberation_periode_calcul_view, name='deliberation_periode_calcul'),
    ...
    path('tl_enseignant_list',views.TlEnseignantListView.as_view(),name='tl_enseignant_list'),
    ...
    re_path(r'^enseignant_tl/(?P<enseignant_pk>\d+)/$',views.EnseignantTLView.as_view(), name='enseignant_tl'),
